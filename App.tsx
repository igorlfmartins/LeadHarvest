      ...
      <div className="min-h-screen font-sans selection:bg-brand-500 selection:text-white transition-colors duration-300 bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100">
        ...
        <header className="border-b transition-colors duration-300 border-brand-700 dark:border-brand-800 bg-brand-600 dark:bg-brand-700 text-white sticky top-0 z-40">
          <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
            <div className="flex flex-col justify-center">
              <img src="/logo.png" alt="LeadHarvest" className="h-12 w-auto object-contain" />
              <p className="text-xs font-sans font-medium tracking-wider text-brand-200 uppercase mt-1 pl-1">
        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Events Database Card */}
            <a
              href="https://airtable.com/appL19ZG07Y5xCC5E/shrWkNLoDuZtZmXez/tbl5EgFRbdYGrEZcb/viwzRpMEzMAMm8b6g"
              target="_blank"
              rel="noreferrer"
              className="group flex flex-col p-6 rounded-2xl border transition-all duration-300 bg-white dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 hover:border-orange-400 dark:hover:border-orange-500/50 shadow-sm hover:shadow-lg dark:hover:shadow-orange-900/10 cursor-pointer"
            >
              <div className="flex items-center gap-3 mb-1">
                <div className="p-2 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400">
                  <Database className="w-5 h-5" />
                </div>
                <span className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Airtable Database</span>
              </div>
              <h3 className="text-2xl font-bold text-slate-700 dark:text-slate-200 group-hover:text-orange-500 transition-colors flex items-center gap-2">
                Open Events Database <ExternalLink className="w-5 h-5 opacity-50 group-hover:opacity-100" />
              </h3>
            </a>

            {/* Companies Database Card */}
            <a
              href="https://airtable.com/appFS5Ogh9IotiOXS/shr2WTKlXlB0tZxPI"
              target="_blank"
              rel="noreferrer"
              className="group flex flex-col p-6 rounded-2xl border transition-all duration-300 bg-white dark:bg-slate-800/40 border-slate-200 dark:border-slate-700 hover:border-orange-400 dark:hover:border-orange-500/50 shadow-sm hover:shadow-lg dark:hover:shadow-orange-900/10 cursor-pointer"
            >
              ...
              <h3 className="text-2xl font-bold text-slate-700 dark:text-slate-200 group-hover:text-orange-500 transition-colors flex items-center gap-2">
                Open Companies Database <ExternalLink className="w-5 h-5 opacity-50 group-hover:opacity-100" />
              </h3>
            </a>
          </div>
            ...
            <div className="lg:col-span-4 space-y-6">
                  ...
                  {isLoadingEvents && events.length === 0 ? (
                    ...
                    events.map(event => (
                      <button
                        ...
                        className={`w-full text-left p-4 rounded-xl border transition-all group ${selectedEventId === event.id
              ...
              <section className="rounded-2xl p-4 h-48 overflow-y-auto font-mono text-xs border transition-colors duration-300 border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800/40 shadow-sm dark:shadow-none flex flex-col">
                <div className="flex-1">
                  ...
                  {logs.map((log, i) => (
                    <div key={i} className={`mb-1.5 ${log.type === 'error' ? 'text-red-500 dark:text-red-400' :
                          ...
                          <td className="p-4 text-right">
                            {company.status === 'enriching' ? (
                              ...
                              <button
                                ...
                                className={`text-xs font-bold px-3 py-1.5 rounded transition-all shadow-lg ${company.airtableStatus === 'exists'
